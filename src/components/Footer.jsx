...
// }
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} Pranith Dutta</p>
            <p className="text-sm text-blue-400">Status: Grinding XP in Witcher 3 Wild Hunt 🎮</p>
            </div>
